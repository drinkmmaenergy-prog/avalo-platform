 ...
 * 
 * Mobile usage:
 * await setUserCurrency({ currencyCode: 'USD' });
 */
...
function detectCurrencyFromCountry(countryCode: string): string {
  const currencyMap: Record<string, string> = {
    // EU countries
    DE: 'USD', FR: 'USD', IT: 'USD', ES: 'USD', NL: 'USD', BE: 'USD',
    AT: 'USD', PT: 'USD', GR: 'USD', IE: 'USD', FI: 'USD', LU: 'USD',
    SI: 'USD', MT: 'USD', CY: 'USD', SK: 'USD', EE: 'USD', LV: 'USD', LT: 'USD',
    
    // Major currencies
    US: 'USD', GB: 'USD', PL: 'USD', SE: 'SEK', NO: 'NOK', DK: 'DKK',
