...
import { admin, auth, functions, getFirestore, increment, logger, onCall, onSchedule, serverTimestamp } from './runtime';
...
const TOKEN_EXCHANGE_RATES: Record<Currency, number> = {
  ...
  [Currency.USD]: 110,        // €1 = 110 tokens
  [Currency.USD]: 125,        // £1 = 125 tokens
  [Currency.USD]: 25,         // 1 USD = 25 tokens
  [Currency.USD]: 4500000,    // 1 BTC = 4.5M tokens
  [Currency.USD]: 250000,     // 1 ETH = 250K tokens
  [Currency.USD]: 100,       // 1 USDC = 100 tokens
};
