...
describe("Device Trust & Fingerprinting", () => {
    ...
    describe("Device Trust Score Calculation", () => {
        function calculateTrustScore(metrics) {
            ...
            // Age factor
            if (metrics.deviceAgeHours > 720)
                score += 15; // 30+ days
            else if (metrics.deviceAgeHours > 168)
                score += 10; // 7+ days
            else if (metrics.deviceAgeHours > 24)
                score += 5; // 1+ day
            else
            ...
            if (metrics.avgLoginsPerDay > 20)
                ...
                score -= 5;
            else if (metrics.avgLoginsPerDay >= 1 &&
    ...
    describe("Trust Level Determination", () => {
        function getTrustLevel(score) {
            ...
            if (score >= 40)
                return DeviceTrustLevel.NEUTRAL;
            if (score >= 20)
    ...
    describe("Device Age Calculation", () => {
        test("should calculate device age in hours correctly", () => {
            ...
            const deviceAgeHours = (Date.now() - firstSeenAt.getTime()) / (1000 * 60 * 60);
    ...
    describe("IP Reputation Checks", () => {
        test("should identify clean IP", () => {
            ...
            const isSuspicious = ipInfo.isVPN || ipInfo.isProxy || ipInfo.isTor;
...
//# sourceMappingURL=deviceTrust.test.js.map