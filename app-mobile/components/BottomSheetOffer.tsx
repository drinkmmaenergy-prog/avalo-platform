/**
 * PHASE 31C - BottomSheetOffer Component
 * UI-only pricing display component for mobile
 * Shows active pricing terms with countdown timer
 */
...
import { DiscountOffer, ActiveDiscount } from '../../shared/types/pricing';
import { 
  getActiveDiscount, 
  formatTimeRemaining,
  clearActiveDiscount 
...
interface BottomSheetOfferProps {
  visible: boolean;
...
export const BottomSheetOffer: React.FC<BottomSheetOfferProps> = ({
  visible,
  offer,
  onClose,
  onActivate,
  ...
  const t = {
    en: {
      limitedTime: 'Member pricing Offer',
              ...
              <View style={styles.header}>
                ...
                <View style={styles.discountBadge}>
                  <Text style={styles.discountBadgeText}>
                    {offer.discountPercent}% member pricing
                  </Text>
                </View>
              </View>
...
export default BottomSheetOffer;
