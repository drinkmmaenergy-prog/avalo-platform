/**
 * FTUX Screen 3: Women grow communities & earn / Men build connections
...
export default function IntroScreen3() {
  ...
  const handleContinue = () => {
    router.push('/onboarding/intro-4' as any);
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {/* Title */}
        <Text style={styles.title}>{t('ftux.title3')}</Text>

        {/* Subtitle */}
        <Text style={styles.subtitle}>{t('ftux.subtitle3')}</Text>
      </Animated.View>
