 ...
 * Shows "+X tokens • up to 65% (reference rate)" badge.
 */
    ...
    <View style={summaryStyles.container}>
      ...
      <View style={summaryStyles.statsGrid}>
        <View style={summaryStyles.statBox}>
          ...
          <Text style={summaryStyles.statSub}>up to 65% (reference rate)</Text>
        </View>
      ...
      <View style={summaryStyles.breakdown}>
        ...
        <View style={summaryStyles.breakdownRow}>
          <Text style={summaryStyles.breakdownLabel}>Your share (up to 65% reference rate)</Text>
