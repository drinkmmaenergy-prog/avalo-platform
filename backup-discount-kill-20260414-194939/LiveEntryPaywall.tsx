        ...
        <View style={styles.container}>
          ...
          <View style={styles.benefitsContainer}>
            ...
            {isVip && (
              <View style={styles.benefit}>
                <Text style={styles.benefitIcon}>👑</Text>
                <Text style={styles.benefitTextVip}>VIP pricing benefit available where eligible</Text>
              </View>
            )}
          </View>
          ...
          <Text style={styles.footerNote}>
            Creator earnings shown as estimated at reference rate; final payout depends on fees and taxes
          </Text>
        </View>
      </View>
    </Modal>
