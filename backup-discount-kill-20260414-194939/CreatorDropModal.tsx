            ...
            {isVip && (
              <View style={styles.vipBadge}>
                ...
                <Text style={styles.vipBadgeText}>
                  {t('creatorDrops.vipBenefit') || 'VIP 5% Discount Applied'}
                </Text>
              </View>
            )}
            ...
            <View style={styles.pricingCard}>
              ...
              <View style={styles.pricingRow}>
                <Text style={styles.pricingSubLabel}>
                  {t('creatorDrops.creatorShare') || 'Creator can earn estimated at reference rate:'}
                </Text>
              ...
              <View style={styles.pricingRow}>
                <Text style={styles.pricingSubLabel}>
                  {t('creatorDrops.avaloFee') || 'Avalo reference portion:'}
                </Text>
                <Text style={styles.pricingSubValue}>
                  {avaloFee} 💎
                </Text>
